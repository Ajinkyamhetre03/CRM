import { 
  ...
  Monitor, Wrench, Calculator, PieChart, Target, Building
} from 'lucide-react';
...
export const employeeNavigationConfig = {
  hr: [
    ...
    { name: 'HR Tasks', path: '/app/hr/tasks', icon: FileText },
  ...
  iot: [
    { name: 'Dashboard', path: '/app/dashboard', icon: Home },
    { name: 'My Profile', path: '/app/profile', icon: Users },
    { name: 'IoT Tasks', path: '/app/iot/tasks', icon: FileText },
...
export const internNavigationConfig = {
  hr: [
    ...
    { name: 'Assigned Tasks', path: '/app/hr/assigned-tasks', icon: FileText },
  ...
  iot: [
    ...
    { name: 'Assigned Tasks', path: '/app/iot/assigned-tasks', icon: FileText },
