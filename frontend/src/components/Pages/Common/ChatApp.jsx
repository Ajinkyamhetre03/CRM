...
const MessageStatus = React.memo(({ status, isGroup = false }) => {
  ...
  return (
    <span className="text-xs ml-1">
      ...
      {status === 'delivered' && <span className="text-blue-900">✓✓</span>}
      {status === 'read' && <span className="text-green-600">✓✓</span>}
    </span>
  );
});
...
const ChatApp = () => {
  ...
  return (
    <div className="flex h-[calc(100vh-10px)] bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-white relative">
      {/* Mobile Overlay */}
