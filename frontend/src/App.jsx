  ...
  return (
    <>
      <Routes>
        ...
        <Route path="/applications/:applicationId/payment-details/:token" element={<PaymentConfromation />} />
        ...
        <Route path="/app" element={
          ...
          <Route path="hr/managertasks" element={
            <ProtectedRoute requiredRole="manager" requiredDepartment="hr">
              <Managertask />
            </ProtectedRoute>
          } />
          <Route path="hr/payment-verification" element={
            <ProtectedRoute requiredRole="manager" requiredDepartment="hr">
              <PaymentVerification />
            </ProtectedRoute>
          } />
          ...
          {/* HR Employee Routes */}
          <Route path="hr/employeetasks" element={
          ...
          <Route path="hr/interntasks" element={
            <ProtectedRoute requiredRole="intern" requiredDepartment="hr">
              <TaskEmployeeIntern/>
            </ProtectedRoute>
          } />
          ...
          <Route path="iot/managertasks" element={
            <ProtectedRoute requiredRole="manager" requiredDepartment="iot">
              <Managertask />
            </ProtectedRoute>
          } />
          ...
          {/* IoT Employee Routes */}
          <Route path="iot/employeetasks" element={
          ...
          <Route path="iot/interntasks" element={
            <ProtectedRoute requiredRole="intern" requiredDepartment="iot">
              <TaskEmployeeIntern />
            </ProtectedRoute>
          } />
          ...
          <Route path="software/managertasks" element={
            <ProtectedRoute requiredRole="manager" requiredDepartment="software">
              <Managertask />
            </ProtectedRoute>
          } />
          ...
          <Route path="software/employeetasks" element={
          ...
          <Route path="software/interntasks" element={
            <ProtectedRoute requiredRole="intern" requiredDepartment="software">
              <TaskEmployeeIntern />
            </ProtectedRoute>
          } />
          ...
          <Route path="financial/managertasks" element={
          ...
          <Route path="financial/employeetasks" element={
          ...
          <Route path="financial/interntasks" element={
            <ProtectedRoute requiredRole="intern" requiredDepartment="financial">
              <TaskEmployeeIntern />
            </ProtectedRoute>
          } />
          ...
          <Route path="business/managertasks" element={
          ...
          <Route path="business/employeetasks" element={
          ...
          <Route path="business/interntasks" element={
